...
class walker_texas_ranger extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $output .= strlen($item->classes[0]) ? ' ' . $this->css_class_prefix . '__item--' . $item->classes[0] : '';
        $output .= '">';
        ...
        // Custom CREATUR Function
        /*
        $this->counter++;
        if($this->counter == $args->menu->count && false){
          // Last element, add search form
          $output .= '<li class="'.$this->item_css_classes['item'].' menu__item--search">';
